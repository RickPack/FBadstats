...
First install the free (open-source) statistical software named "R" (use http://rseek.org to research) at:
...
Load RStudio and you can now install the fbadstats package from github by entering the following in RStudio:
